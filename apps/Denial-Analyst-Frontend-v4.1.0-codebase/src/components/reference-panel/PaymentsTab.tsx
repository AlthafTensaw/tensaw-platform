...
import type { Transaction, TransactionType, PayerSource } from '../../actions/schemas-v4-tabs';
...
export function PaymentsTab({ caseId }: PaymentsTabProps): React.ReactElement {
