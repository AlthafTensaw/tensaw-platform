...
export const CATEGORY_VALUES = [
  // 1. Denied-claim categories (claim status = denied)
  '01. Prior Authorization Denied',
  '02. Wrong Payer / Misrouted',
  '03. Referral Missing',
  '04. Medical Record Missing',
  '05. Documentation Missing (Facesheet/Demo)',
  '06. Coding - Bundled',
  '07. Medical Necessity / LCD',
  '08. Out of Network / Non-Par',
  '09. Timely Filing Exceeded',
  '10. Duplicate / Already Paid',
  '11. Provider Credentialing / NPI',
  '12. Overpayment Refund Request',
  '13. Fee Schedule / Contractual Writeoff',
  '14. Vague Denial / Need Payer Call',
  '15. Coding - Modifier',
  '16. Coding - Diagnosis / ICD',
  '17. Coding - CPT/HCPCS Missing',
  '18. IDE / Clinical Trial Special',
  '19. Patient Eligibility / Coverage Timing',
  '20. COB / Secondary Payer',
  '21. Plan Benefit Restriction',
  '22. Informational ($0 - No Action)',
  '23. Non-Appealable Alert',
  '24. Units Issue',
  '25. Predetermination',
  '26. Patient Responsibility',
  '27. Claims Edit / Scrubber',
  '28. Special Program (Non-Demonstration)',
  '99. Uncategorized',
] as const;
