...
function problem(
  ...
  const env = buildErrorEnvelope(errorCode, detail, { title, status, ...extra });
...
export function buildDenialHandlers(baseUrl: string) {
  ...
  return [
    ...
    http.get(u('/v1/claims/worklist'), ({ request }) => {
      ...
      return HttpResponse.json(buildSuccessEnvelope({
        rows: paged,
        total,
        page: req.page,
    ...
    http.get(u('/v1/classifications/:classification_id'), ({ params }) => {
      ...
      return HttpResponse.json(buildSuccessEnvelope(row.classification));
    }),
    ...
    http.get(u('/v1/claims/:claim_id'), ({ params }) => {
      ...
      return HttpResponse.json(buildSuccessEnvelope(detail));
    }),
    ...
    http.get(u('/v1/claims/:claim_id/denial-events'), ({ params }) => {
      ...
      return HttpResponse.json(buildSuccessEnvelope(events));
    }),
    ...
    http.post(
      ...
      async ({ params, request }) => {
        ...
        return HttpResponse.json(buildSuccessEnvelope(transitionResponse(id, prev, 'accepted')));
      },
    ),
    ...
    http.post(
      ...
      async ({ params, request }) => {
        ...
        return HttpResponse.json(buildSuccessEnvelope(transitionResponse(id, prev, 'overridden')));
      },
    ),
    ...
    http.post(
      ...
      async ({ params, request }) => {
        ...
        return HttpResponse.json(buildSuccessEnvelope(transitionResponse(id, prev, 'completed')));
      },
    ),
    ...
    http.post(
      ...
      async ({ params, request }) => {
        ...
        return HttpResponse.json(buildSuccessEnvelope(response), { status: 201 });
      },
    ),
    ...
    http.post(u('/v1/classifications/bulk-accept'), async ({ request }) => {
      ...
      return HttpResponse.json(buildSuccessEnvelope(response));
    }),
    ...
    http.post(u('/v1/claims/:claim_id/classify'), ({ params }) => {
      ...
      return HttpResponse.json(buildSuccessEnvelope(fresh));
    }),
    ...
    http.get(u('/v1/cost/daily'), ({ request }) => {
      ...
      return HttpResponse.json(buildSuccessEnvelope(buildCostSummary(start, end)));
    }),
  ];
}
